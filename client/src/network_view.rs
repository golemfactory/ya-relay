...
use crate::session_state::{InitState, ReverseState, SessionState};
use crate::session_traits::SessionDeregistration;
...
mod tests {
    ...
    use crate::session_state::{InitState, RelayedState};
